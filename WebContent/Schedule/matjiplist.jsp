...
String ilocation = request.getParameter("ilocation2");
...
<body>
			...
			<div class="option">
				<div>
					<form method="post" onsubmit="searchPlaces(); return false;">
						키워드 : <input type="text" value="<%=ilocation%> 맛집" id="keyword"
							size="15">
	...
	<center>
		<button onclick="window.open('http://www.mangoplate.com/')">
		더 많은 맛집 보러가기! - 망고플레이트</button>
		<hr>
		<h1>Moim Project</h1>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=66456b23502b56417576028b1dca9cf4&libraries=services"></script>
	<script>
		// 마커를 담을 배열입니다
		var markers = [];
